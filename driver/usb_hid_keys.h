...
#define USB_HID_KEY_MEDIA_PLAYPAUSE 0xCD
#define USB_HID_KEY_MEDIA_PREVIOUSSONG  0xB6
#define USB_HID_KEY_MEDIA_NEXTSONG  0xB5
#define USB_HID_KEY_MEDIA_VOLUMEUP 0xED
#define USB_HID_KEY_MEDIA_VOLUMEDOWN 0xEE
#define USB_HID_KEY_MEDIA_MUTE 0xE2
